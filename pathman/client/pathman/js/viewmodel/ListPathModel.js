...
(function (nx, global) {
    nx.define('pathman.viewmodel.ListPath', nx.data.ObservableObject, {
        properties: {
            entries: {
                value: function () {
        ...
        methods: {
            init: function(inParent, view) {
                ...
                this.footer(new pathman.viewmodel.ListPathFooter(this, view.view('footer')));
                view.model(this);
                this.load();
            },
            load: function () {
                ...
                nx.backend.listLSPs(function(lsps) {
                    ...
                    for (var i = 0; i < lsps.length; i++) {
                        ...
                        self.entries().add(new pathman.viewmodel.NamePath(self, i, name, path));
                    }
                });
            },
