(function (nx, global) {
    nx.define('pathman.viewmodel.PathInfo', nx.data.ObservableObject, {
        properties: {
            'class': 'panel-title',
        ...
        methods: {
            init: function(inParent, view) {
                ...
                //this.metricSelector(new pathman.viewmodel.MetricSelector(this, view.view('metricSelector')));
                this.createPath(new pathman.viewmodel.CreatePath(this, view.view('createPath')));
                this.listPath(new pathman.viewmodel.ListPath(this, view.view('listPath')));
                view.model(this);
            },
