...
def get_url(url):
    ''' generic get url - one place error control can be added'''
    try:
        ...
        #nprint("Error: %s, on open %s" %(e,url ), debug)
        logging.info("Error: %s, on open %s" %(e,url ))
        return ''
    except ValueError, e:
        #nprint("Error: %s, on open %s" %(e,url ), debug)
        logging.info("Error: %s, on open %s" %(e,url ))
...
def locations_of_substring(string, substring):
    """ Return a list of all locations of a substring in string."""
